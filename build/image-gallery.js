...
var ImageGallery = function (_React$Component) {
  ...
  _createClass(ImageGallery, [{
    ...
    value: function getAlignmentClassName(index) {
      ...
      var centerClassName = transition === 'fade' ? 'center show' : 'center';
    ...
    value: function getSlideStyle(index) {
      var _state5 = this.state,
          ...
          _state5$slideStyle = _state5.slideStyle,
          slideStyle = _state5$slideStyle === undefined ? {} : _state5$slideStyle;
      var _props5 = this.props,
          ...
          slideDuration = _props5.slideDuration;

      if (transition === 'fade') {
        var transitionOfSlideStyle = slideStyle.transition || '';
        var combinedTransitionSlideStyle = {
          transition: transitionOfSlideStyle + ', opacity ' + slideDuration + 'ms'
        };
        return _extends({}, slideStyle, combinedTransitionSlideStyle);
      }
      var baseTranslateX = -100 * currentIndex;
    ...
    value: function getSlideItems() {
      ...
      items.forEach(function (item, index) {
        ...
        var className = transition === 'fade' ? 'image-gallery-slide fade ' + alignment + ' ' + originalClass : 'image-gallery-slide ' + alignment + ' ' + originalClass;
